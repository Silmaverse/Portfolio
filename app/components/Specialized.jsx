      ...
      <section id='specalized' className='mt-36 bg-[#FBFBFB] py-[114px]'>
        <div className="container">
          ...
          <div className="special_row">
            ...
            <CommonCard spicon={Spicon}  title={"UI/UX Design"} description={"Turn what you have in mind of a digital product into reality. For any platform you consider."} />

          
            <CommonCard spicon={Spiocn1}  title={"Application Development"} description={"Standard designing, building, and implementing your applications with documentation."} />

            <CommonCard spicon={Spicon2}  title={"Web Development"} description={"Create and maintain your websites and also take care of its performance and traffic capacity."} />
